      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="font-display font-bold text-2xl">Global Imports</span>
            </div>
            ...
            <div className="flex items-center gap-4">
              {[
                { icon: Linkedin, href: "#" },
                { icon: Twitter, href: "#" },
                { icon: Mail, href: "mailto:globalimportsworldwide@gmail.com" },
              ].map((social, index) => (
                <motion.a
                  key={index}
                  href={social.href}
          ...
          >
            ...
            <ul className="space-y-3">
              {["Import & Export", "B2B Trading", "Logistics Support", "Quality Control", "Bulk Sourcing"].map(
                (service) => (
                  <li key={service}>
          ...
          >
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-primary-foreground/60">+91 90116 75477</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-primary flex-shrink-0" />
                <span className="text-primary-foreground/60">+91 88307 83396</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-primary flex-shrink-0" />
                <span className="text-primary-foreground/60">+91 92701 09911</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-primary flex-shrink-0" />
                <span className="text-primary-foreground/60">+91 98230 50721</span>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-primary flex-shrink-0" />
                <span className="text-primary-foreground/60">globalimportsworldwide@gmail.com</span>
              </li>
            </ul>
          </motion.div>
        </div>
        ...
        <div className="pt-8 border-t border-primary-foreground/10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-primary-foreground/40 text-sm">© {currentYear} Global Imports. All rights reserved.</p>
